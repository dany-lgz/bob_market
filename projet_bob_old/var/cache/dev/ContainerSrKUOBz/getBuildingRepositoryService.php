...
// Returns the private 'App\Repository\BuildingRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/BuildingRepository.php';

return $this->privates['App\Repository\BuildingRepository'] = new \App\Repository\BuildingRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
